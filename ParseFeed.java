...
public class ParseFeed {
	...
	//helper method to get data form "tourist attsractions.txt" file
	public static List<PointFeature> parseAttractions(PApplet p, String fileName) {
		List<PointFeature> features = new ArrayList<PointFeature>();
